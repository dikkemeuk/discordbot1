...
module.exports = class extends Command {
    ...
    constructor(...args) {
        super(...args, {
            ...
            requiredSettings: [],
            subcommands: false,
            description: 'Pause the music for a moment.',
    ...
    async run(msg) {
        ...
        if(dispatcher.player.paused) return msg.send("The music is already on pause..")
        await dispatcher.player.setPaused(true)
        msg.send(`Paused the music successfully!`)
